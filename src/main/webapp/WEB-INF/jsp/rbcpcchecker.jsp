...
<head>
  <meta charset="UTF-8">
  <title>RBCPC Checker Queue</title>
  <meta charset="utf-8">
    ...
    <div class="kt">
      <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-0 ms-3 mb-3 mt-1">
        <div class="d-flex align-items-center mt-2 mb-2">
          ...
          <div data-kt-countup="true" data-kt-countup-value="15000" data-kt-countup-prefix="$" data-kt-initialized="1" class="fs-8  fw-bold counted ms-2">RBCPC Checker Queue</div>
        </div>
      </div>
    </div>
              ...
              <div class="card card-xl-stretch mb-5 mb-xl-8">
                ...
                <div class="card-body py-3">
                  <div class="table-responsive">
                    <form name="wibmlist" id="wibmlist" method="post" action="wicpcchecker">
                      ...
                      <table class="table align-middle table-row-dashed fs-8 gy-3" id="branch-maker-queue-details-table">
                        ...
                        <%
                          ...
                          List<VehicleLoanRBCPCDTO> entryQueue = (List<VehicleLoanRBCPCDTO>) request.getAttribute("rbcQueue");
                          int count = 1;
                          for (VehicleLoanRBCPCDTO item : entryQueue) {
                            String lockDetails ="";
                            if ( !userId.equals(item.getLockedBy()) && "Y".equals(item.getLockedFlag())) {
                              lockDetails= "<i class='ki-duotone ki-lock-3'>" +
                                      "<span class='path1'></span>" +
                                      "<span class='path2'></span>" +
                                      "<span class='path3'></span>" +
                                      "</i> Locked By -"+item.getLockedBy();
                            }
                        %>
                        <tr>
                          <td>
                          ...
                          <%--                          </td>--%>
                          <td><%=item.getLastLockUser()%></td>
                          <td><%=item.getLastLockDate()%></td>
                        </tr>
                        <% } %>
                        </tbody>
                      </table>

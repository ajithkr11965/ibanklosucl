...
<head>
  <meta charset="UTF-8">
  <title>Branch Checker Queue</title>
  <meta charset="utf-8">
  ...
  <div class="page-header-content d-lg-flex">
    ...
    <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-0 ms-3 mb-3 mt-1">
      <div class="d-flex align-items-center mt-2 mb-2">
        ...
        <div data-kt-countup="true" data-kt-countup-value="15000" data-kt-countup-prefix="$" data-kt-initialized="1" class="fs-8  fw-bold counted ms-2">Branch Checker Queue</div>
      </div>
    </div>
    </div>
...
<%--                    </form>--%>
                ...
                <div class="card-body py-3">
                  <div class="table-responsive">
                    <form name="wibmlist" id="wibmlist" method="post" action="hunterqueue">
...
<%--                          <th>Status</th>--%>
                        ...
                        <%
                          ...
                          List<VehicleLoanMasterDTO> entryQueue = (List<VehicleLoanMasterDTO>) request.getAttribute("bcQueue");
                          int count = 1;

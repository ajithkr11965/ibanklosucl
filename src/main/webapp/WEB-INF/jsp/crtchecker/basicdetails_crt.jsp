...
<%
    ...
    String permanentdisbaled="" ,basic_edu="",basic_pep="",editable="",commEditable="";
    String basic_cpoa="" ,basic_cpoadoc="",basic_cpoaext="",basic_occupation="";
    if(applicant!=null)
    {
...
<form   class="det form-details  basicdetails" data-code="<%=apptype%>-3"  data-completed="<%=completed%>"  action="#">
    ...
    <div class="row mb-3">
        ...
        <div class="d-flex justify-content-center mt-3 ">
            <button class="btn btn-outline-info   my-1 me-2 losdedup-button"><i class="ph-file-cloud  ms-2"></i>Los -ve List</button>
        </div>
        ...
        <div class="d-flex justify-content-center">
            <button class="btn btn-outline-pink  my-1 me-2 findedup-button"><i class="ph-file-cloud  ms-2"></i>Finacle Dedup</button>
        </div>
        <div class="table-responsive  rounded  mb-3" >

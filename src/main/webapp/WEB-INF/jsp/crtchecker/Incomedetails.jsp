									...
									for (VehicleLoanBSA bsaDetails : vehicleLoanBSAList) {
										if ("N".equals(bsaDetails.getDelFlg())) {
											...
											if (responseValue != null) {
												...
												abbIncome = String.valueOf(((Map<String, Object>) data.get("bsaData")).get("averageBankBalance"));

												String tableHtml = "";
												tableHtml += "<table class='table table-border-dashed'>";
												tableHtml += "<tr><th colspan='12'>Account Information</th></tr>";
												tableHtml += "<tr>";
												...
												tableHtml += "<tr><th colspan='12'>Monthly Details</th></tr>";
												tableHtml += "<tr><th>Month</th><th>Total Credits</th><th>Total Debits</th><th>Balance Min</th><th>Balance Max</th><th>Balance Avg</th><th>Penal Charges</th><th>Outward Bounces</th><th>Total Salary</th><th>Inward Bounces</th></tr>";

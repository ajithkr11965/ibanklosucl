	...
	<div class="d-flex flex-stack border rounded px-7 py-3 mb-2">
			...
			<div class="w-100">
				<div class="accordion-header d-flex  " data-bs-toggle="collapse" id="blacklistDetails" data-bs-target="#blacklisttable">
					<label class="btn btn-outline btn-outline-dashed btn-active-light-success acdlen justify-content-start p-5 d-flex align-items-center mb-2 btn-light-success " for="blacklisttable">

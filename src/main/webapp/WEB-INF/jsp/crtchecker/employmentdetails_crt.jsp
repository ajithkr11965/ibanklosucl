...
<%
    ...
    if(applicant!=null) {
        ...
        if(employment!=null) {
            ...
            completed = true;
            applicant_age =employment.getRetirement_age()==null?"":employment.getRetirement_age();
        }
                    ...
                    <table class="table table-bordered emptable-sal-pen"  >
                        ...
                        <%
                            for( VLEmploymentemp vlEmployment : vlEmploymentempList) {
                                ...
                                {
                                    totalEmpExp= totalEmpExp+Integer.parseInt(vlEmployment.getWorkExperience()==null?"0":vlEmployment.getWorkExperience());
                        %>
                        <tr>
                    ...
                    <table class="table table-bordered emptable-oth"  >
                        ...
                        <%
                            for( VLEmploymentocc vlEmployment : vlEmploymentoccList) {
                                if(vlEmployment.getDelFlg().equals("N"))
                                {
                                    totalBusExp= totalBusExp+Integer.parseInt(vlEmployment.getBusinessExperience()==null?"0":vlEmployment.getBusinessExperience());
                        %>
                        <tr>
                            <%--                            <td>--%>
                            ...
                            <%--                                </select>--%>
                            <%--                            </td>--%>
                            <td><input type="text" name="empothtype" id="empothtype" class="form-control"  placeholder="Enter Name" value="<%=vlEmployment.getOccupationType()%>"></td>
                            <td><input type="text" name="empothcode" id="empothcode" class="form-control empworkexp-oth"  placeholder="Enter Experience" value="<%=vlEmployment.getOccupationCode()%>"></td>
                            <td>

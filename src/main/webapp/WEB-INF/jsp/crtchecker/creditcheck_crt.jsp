...
<form   class="det form-details creditCheck" data-code="<%=apptype%>-6"  data-completed="<%=completed%>"  action="#">
    ...
    <div class="row mt-1 d-flex justify-content-center crchk-experionscore" style="<%= "done".equals(crchk) ? "" : "display:none !important" %>" name="crchk-experionscore">
        ...
        <div class="col-lg-4">
            <div class="text-center badge bg-light text-body experian_fetchTime  p-2 mb-1 w-100 "></div>
        ...
        <div id="emptable-sal-div-id" class="table-responsive border-white border-opacity-15  crchk-inc-lia-div">
            ...
            <table class="table table-bordered crchk-inc-lia-table"  >
                ...
                <tr>
                    ...
                    <td><input type="text" name="lianaturelimit" id="lianaturelimit" class="form-control"  placeholder="Enter Nature of Limit" value="<%=vlliab.getNatureLim()%>"></td>
                    <td><input type="text" name="lialimit" id="lialimit" class="form-control"  placeholder="Enter Limit" value="<%=vlliab.getLimit()%>"></td>
                    <td><input type="text" name="liaoutstanding" id="liaoutstanding" class="form-control"  placeholder="Enter Outstanding" value="<%=vlliab.getOutStanding()%>"></td>
                    <td><input type="text" name="liaemi" id="liaemi" class="form-control"  placeholder="Enter EMI" value="<%=vlliab.getEmi()%>"></td>
                    <td><input type="text" name="liamodifiedemi" id="liamodifiedemi" class="form-control" placeholder="Enter Modified EMI" value="<%=vlliab.getModifiedEmi()%>"></td>

                            ...
                            <div class="card card-xl-stretch mb-5 mb-xl-8">
                                ...
                                <div class="card-body py-3">
                                    <div class="table-responsive">
                                        <form name="wicalist" id="wicalist" method="post" action="../<%=request.getAttribute("reportPath").toString()%>">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="p-5">
                                                        <div class=" mb-5">
                                                            ...
                                                            <input class="form-control "  type="date" name="fromdt" id="fromdt">
                                                        </div>
                                                        <div class=" mb-5">
                                                            <div  class="fw-semibold">
                                                                Please choose To date.
                                                            </div>
                                                            <input class="form-control "  type="date" name="todt" id="todt">
                                                        </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#genrep').click(function (e){
            ...
            else if($('#fromdt').val().length!==0 && $('#todt').val().length ===0){

                    ...
                    <form name="wicalist" id="wicalist" method="post" action="#">
                      ...
                      <table class="table align-middle table-row-dashed fs-8 gy-3" id="branch-maker-queue-details-table">
                        ...
                        <%
                          ...
                          List<Map<String,String>> dtlrpt = (List<Map<String,String>>) request.getAttribute("livereport");
                          int count = 1;
                          ...
                          <td>
                            <div class="col">
                              <div class="d-flex align-items-center me-2">
                                <div>
                                  <div class="fs-7 fw-bold me-2"><%= item.get("APPLICATION_NO") %>
                                  </div>
                                </div>
                              </div>
                            </div>
                          ...
                          <td>
                            <div class="d-flex align-items-center">
                              <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                <div class="symbol-label fs-3 bg-light-success text-success"><%= item.get("CUSTOMER_NAME").substring(0, 1) %>
                                </div>
                          ...
                          <td>
                            <div class="col">
                              <div class="d-flex align-items-center me-2">
                                ...
                                <!--begin::Title-->
                                <div>
                                  <div class="fs-9 text-muted fw-bold"><%=item.get("LOAN_FACILITY_TYPE")%>
                                  </div>
                                </div>
                                <!--end::Title-->
                              </div>

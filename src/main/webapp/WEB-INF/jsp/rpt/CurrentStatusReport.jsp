        ...
        <div class="kt">
            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-0 ms-3 mb-3 mt-1">
                <div class="d-flex align-items-center mt-2 mb-2">
                    ...
                    <div data-kt-countup="true" data-kt-countup-value="15000" data-kt-countup-prefix="$" data-kt-initialized="1" class="fs-8  fw-bold counted ms-2">Current status of Live WIs Reporrt</div>
                </div>
            </div>
        </div>
                                        ...
                                        <form name="wicalist" id="wicalist" method="post" action="#">
                                            <table class="table align-middle table-row-dashed fs-8 gy-3" id="branch-maker-queue-details-table">
                                                ...
                                                <tr class="text-start text-gray-400 fw-bold fs-8 text-uppercase gs-0">
                                                    ...
                                                    <th>Last Received in the Current Queue</th>
                                                    <th>Queue</th>
                                                    <th>Channel</th>
                                                    <th>STP</th>
                                                    <th>Sanctioned</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><%=item.get("CMDATE") != null ? item.get("CMDATE") : "" %></td>
                                                    <td><%=item.get("CUST_NAME") != null ? item.get("CUST_NAME") : "" %></td>
                                                    <td><%=item.get("QUEUE_ENTRY_DATE") != null ? item.get("QUEUE_ENTRY_DATE") : "" %></td>
                                                    <td><%=item.get("QUEUE_DESC") != null ? item.get("QUEUE_DESC") : "" %></td>
                                                    <td><%=item.get("CHANNEL") != null ? item.get("CHANNEL") : "" %></td>
                                                    <td><%=item.get("STP") != null ? item.get("STP") : "" %></td>
                                                    <td><%=item.get("SAN_DATE") != null ? "YES": "NO" %></td>
                                                    <td><%=item.get("QUEUE") != null && item.get("QUEUE").equalsIgnoreCase("NIL") ? "YES" : "NO" %></td>
                                                    <td><%=item.get("Program") != null ? item.get("Program") : "" %></td>
                                                    <td><%=item.get("LOAN_AMT") != null ? item.get("LOAN_AMT") : "" %></td>
                                                    <td><%=item.get("ELIGIBLE_LOAN_AMT") != null ? item.get("ELIGIBLE_LOAN_AMT") : "" %></td>

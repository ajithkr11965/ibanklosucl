    ...
    <div class="kt">
      <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-0 ms-3 mb-3 mt-1">
        <div class="d-flex align-items-center mt-2 mb-2">
          ...
          <div data-kt-countup="true" data-kt-countup-value="15000" data-kt-countup-prefix="$" data-kt-initialized="1" class="fs-8  fw-bold counted ms-2">Waiver Approval Queue</div>
        </div>
      </div>
    </div>
...
<div class="page-content pt-0">
  <%request.setAttribute("TAB","WAIVE");%>
              ...
              <div class="card card-xl-stretch mb-5 mb-xl-8">
                ...
                <div class="card-body py-3">
                  <div class="table-responsive">
                    <form name="wibmlist" id="wibmlist" method="post" action="waiverqueue">
                      ...
                      <table class="table align-middle table-row-dashed fs-8 gy-3" id="branch-maker-queue-details-table">
                        ...
                        <%
                          ...
                          List<WaiverSubtaskDTO> entryQueue = (List<WaiverSubtaskDTO>) request.getAttribute("waiverQueue");
                          int count = 1;
                          for (WaiverSubtaskDTO item : entryQueue) {

                            String lockDetails ="";
                            if ( !userId.equals(item.getLockedBy()) && "Y".equals(item.getLockFlg())) {

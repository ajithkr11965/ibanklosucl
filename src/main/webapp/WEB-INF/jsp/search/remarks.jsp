...
<div class="flex-stack border rounded px-7 py-3 mb-2">
  <div class="">
    <div class="accordion-header d-flex collapse show " data-bs-toggle="collapse"  aria-expanded="true" id="decisionDetailslink" data-bs-target="#decisionDetailsContent">
      <label class="btn btn-outline btn-outline-dashed  acdlen justify-content-start  p-5 d-flex align-items-center mb-2"
             for="decisionDetailsContent"><!--btn-active-light-primary-->
        <i class="ki-duotone ki-element-9 fs-3x me-4">
          <span class="path1"></span>
          <span class="path2"></span>
        </i>
        <span class="d-block fw-semibold text-start">
                    <span class="text-gray-900 fw-bold d-block fs-4">Remarks</span>
          ...
          <div id="kt_docs_repeater_basic">
            <form id="rc_decision" name="rc_decision" class="form" method="POST">
              ...
              <div class="mb-10 pt-5 fv-row fv-plugins-icon-container">
                ...
                <!--end::Label-->
                <!--begin::Input-->
                <textarea class="form-control" readonly aria-label="With textarea" id="remarks" name="remarks" maxlength="500"><%=remarks%></textarea>
                <!--end::Input-->
                <div class="fv-plugins-message-container invalid-feedback"></div>
              </div>
            </form>
<%--            <div class="text-end pt-5">--%>
<%--              <button type="button" id="rcsave" class="btn btn-lg btn-primary" data-kt-stepper-action="next">Save--%>

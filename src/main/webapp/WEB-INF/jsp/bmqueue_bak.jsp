				...
				<div class="kt">
					<div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-0 ms-3 mb-3 mt-1">
						<div class="d-flex align-items-center mt-2 mb-2">
							...
							<div data-kt-countup="true" data-kt-countup-value="15000" data-kt-countup-prefix="$" data-kt-initialized="1" class="fs-8  fw-bold counted ms-2">Branch Maker</div>
						</div>
					</div>
				</div>
														...
														<tbody class="fw-semibold text-gray-600">
															...
															<tr>
																<td>
																	...
																	<button type="button" name="modify-btn" value="Modify"
																...
																<td>
																	<button type="button" class="btn btn-flat-danger border-transparent btn-sm bmlistdelbtn" data-slno="<%=item.getSlno()%>">
																		<i class="ph-trash"></i>
																	</button>
																</td>
															</tr>
		...
		<script>
			...
			$('#branch-maker-queue-details-table').on('click','.modify-btn',function (e) {
				...
				$('.bmlistdelbtn').on('click', function (e) {
					var slno = $(this).data('slno');
					var msg= "Kindly note that, this WI will get deleted and sms+email will be sent to the customer(for DSA channel). Are you sure?";
					var f = confirm(msg);
					if(f){
						bmlistDelWI( slno);
					}

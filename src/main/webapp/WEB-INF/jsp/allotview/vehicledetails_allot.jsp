            ...
            <div class="mb-3 mt-3">
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="col-lg-12 form-control-feedback form-control-feedback-start" >
                    <input type="text" id="dealer_code" class="form-control" value="<%= dealerCode %>" disabled>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="mb-3 mt-3">
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="col-lg-12 form-control-feedback form-control-feedback-start">
                    <select id="dealer_sub_code" class="form-control select" disabled>
                      <option value="<%= dealerSubCode %>"><%= dealerSubCode %></option>
                    </select>
                  </div>
                </div>
              </div>
            ...
            <div class="mt-3">
              <table class="table table-bordered" id="variant-details">
                ...
                <tr>
                  ...
                  <td><input type="number" step="0.01" disabled name="other" id="other" class="form-control" value="<%= otherPrice %>" readonly></td>

  ...
  <div class="container-fluid">
    ...
    <div class="navbar-collapse collapse order-2 order-lg-1" >
								<span class="navbar-text d-none d-lg-inline-flex align-items-lg=center me-3">
                                  ...
                                  <input type="hidden" id="makerCheckerSame" value="<%=request.getAttribute("makerCheckerSame")%>"/>
                                  makerCheckerSame
    ...
    <div class="content">
      ...
      <div class="d-flex flex-row min-vh-100">
        <div id="appList" class="w-100">
          ...
          <div class="card">
            ...
            <ul class="nav nav-tabs nav-justified mb-0" role="tablist" id="loanapp">
              ...
              <li class="nav-item" role="presentation"><a href="#tab-C-<%=coApplicantCount%>" class="nav-link apptype   alert alert-primary  " data-bs-toggle="tab" aria-selected="false" role="tab" tabindex="-1" data-app="C-<%=coApplicantCount%>"><i class="ph-user-circle-plus "></i><span data-applicationtype="C">Co-Applicant-<%=coApplicantCount%></span>
                <button type="button" class="btn-close closeapplicant pe-5" data-closecode="C-<%=coApplicantCount%>"></button></a>
              </li>
              <%
                coApplicantCount++;
              }
            ...
            <div class="tab-content card-body" id="loanbody">
              ...
              <div class="tab-pane fade active show" id="tab-A" role="tabpanel">
                ...
                <jsp:include page="docqueue/kycdetails_bd.jsp" />
          ...
          <div class="w-100 kt">
            <form id="wibogassetform" class="z-index-0"  action="wibogassetsave">
                    ...
                    <div class="1"  style="background: #fff !important;">
                      ...
                      <div class="rounded border p-2 mb-3">
                        ...
                        <div class="accordion accordion-icon-collapse" id="vl_rc_int" data-state="2">
                          ...
                          <jsp:include page="docqueue/blacklistdetails_bd.jsp" />
                          <jsp:include page="docqueue/deviationdetails_bd.jsp" />

                          <jsp:include page="bogassets/repayment_ac.jsp" />
                          <jsp:include page="bogassets/sanction_ac.jsp" />
                            <%
                            request.setAttribute("checker","1");
                            %>
                          <jsp:include page="bogassets/sanmodification_ac.jsp" />
                        ...
                        <div class="text-center">
                          <button type="button" id="WISMAPPROVEBTN" class="btn btn-sm btn-success  ms-1 me-1 wismbtn">Approve<i class="ph-paper-plane-tilt ms-2"></i></button>
                          <button type="button" id="WISMREJBTN" class="btn btn-sm btn-danger  ms-1 me-1 wismbtn">Reject<i class="ph-paper-plane-tilt ms-2"></i></button>
...
//addCoApplicantBtn.prop('disabled', true);
    ...
    $('.wismbtn').on('click', function (e) {
      ...
      var ff=0;
      var action='';
      if(this.id=='WISMAPPROVEBTN'){
        action='APPROVE';
      }else if(this.id=='WISMREJBTN'){
        action='REJECT';
      }else{
        ff=-1;
      }
      ...
      if(msg!=''){
        ...
        saveform(winum, slno, remarks,action);
      }
    });
  });
  function saveform(winum, slno, remarks, action){

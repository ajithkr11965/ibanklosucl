...
<head>
  <meta charset="UTF-8">
  <title>Branch Sendback Queue</title>
  <meta charset="utf-8">
    ...
    <div class="kt">
      <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-0 ms-3 mb-3 mt-1">
        <div class="d-flex align-items-center mt-2 mb-2">
          ...
          <div data-kt-countup="true" data-kt-countup-value="15000" data-kt-countup-prefix="$" data-kt-initialized="1" class="fs-8  fw-bold counted ms-2">Branch Sendback Queue</div>
        </div>
      </div>
    </div>
              ...
              <div class="card card-xl-stretch mb-5 mb-xl-8">
                <div class="card-header border-0 pt-5">
                  ...
                  <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                    ...
                    <%--                    <form name="wicreate" id="wicreate" method="post" action="wichecker">--%>
                ...
                <div class="card-body py-3">
                  <div class="table-responsive">
                    <form name="bslistfrm" id="bslistfrm" method="post" action="wicreate">
                      <input type="hidden" name="slno" value="" id="slno">
                      <input type="hidden" name="action" value="BC" id="action_mod">
                      <table class="table align-middle table-row-dashed fs-8 gy-3" id="branch-maker-queue-details-table">
                        ...
                        <tr class="text-start text-gray-400 fw-bold fs-8 text-uppercase gs-0">
                          ...
                          <th>Appl Date</th>
                          <th>Channel</th>
                          <th>Sent back from</th>
                          <th>Sent back by PPC</th>
                          <th>Sent back on</th>
                          <%--                          <th>Status</th>--%>
                        </tr>
                        </thead>
                        ...
                        <%
                          ...
                          List<Map<String, String>> entryQueue = (List<Map<String, String>>) request.getAttribute("bsQueue");
                          int count = 1;
                          for (Map<String, String> item : entryQueue) {
                            String lockDetails ="";
                            if ( !userId.equals(item.get("locked_by")) && "Y".equals(item.get("lock_flg"))) {
                              lockDetails= "<i class='ki-duotone ki-lock-3'>" +
                                      "<span class='path1'></span>" +
                                      "<span class='path2'></span>" +
                                      "<span class='path3'></span>" +
                                      "</i> Locked By -"+item.get("locked_by");
                            }
                        %>
                        <tr>
                          <td>

                            <button type="button" name="modify-btn" value="BS"
                                    class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 modify-btn pulse pulse-primary"
                                    data-slno="<%=item.get("slno")%>"
                            >
                          ...
                          <td>
                            <div class="col">
                              <div class="d-flex align-items-center me-2">
                                <div>
                                  <div class="fs-7 fw-bold me-2"><%= item.get("wi_num") %>
                                  </div>
                                </div>
                                <%if (!userId.equals(item.get("locked_by")) && "Y".equals(item.get("lock_flg"))) {%>
                                <i class="ki-duotone ki-lock fs-7 text-warning" data-bs-custom-class="tooltip-inverse" data-bs-toggle="tooltip"
                          ...
                          <td>
                            <div class="d-flex align-items-center">
                              <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                <div class="symbol-label fs-3 bg-light-success text-success"><%= item.get("cust_name").substring(0, 1) %>
                                </div>
                          ...
                          <td>
                            <div class="col">
                              <div class="d-flex align-items-center me-2">
                                ...
                                <!--begin::Title-->
                                <div>
                                  <div class="fs-9 text-muted fw-bold"><%=item.get("channel")%>
                                  </div>
                                </div>
                                <!--end::Title-->
                          ...
                          <td><%=item.get("previousqueue")%>
                          </td>
                          <td><%=item.get("queue_Exit_User")%>
                          </td>
                          <td><%=item.get("queue_Exit_Date")%>
                          </td>

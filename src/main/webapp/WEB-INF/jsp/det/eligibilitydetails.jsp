        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            <div class="text-center mt-3" <%= checker ? "style='display:none'" : "" %>>
              <button type="button" class="btn btn-primary check-eligibility-button comon">Check Eligibility</button>
            </div>
          </div>
        </div>
      </li>
            ...
            <div class="col-lg-12">
              <div class="mb-3 mt-3">
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="text-center mt-3" <%= checker ? "style='display:none'" : "" %>>
                      <button type="button" class="btn btn-primary proceed-button comon">Proceed</button>
                    </div>
                  </div>
                </div>
              </div>

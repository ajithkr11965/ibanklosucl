...
<%--            </div>--%>
        ...
        <div class="col-lg-6 otppage <%=uidotp%>">

            <div class="mb-2"><br/><br/>
                <label class="form-label">Enter Otp</label>
                <div class="form-control-feedback form-control-feedback-start">
                    <input type="text" class="form-control uidotpval" placeholder="" name="uidotpval" maxlength="6" minlength="6">
                    <div class="form-control-feedback-icon">
                        <i class="ph-note text-muted"></i>
                    </div>
                </div>
            </div>
            <div class="mb-2 text-center">
                <button type="submit"  class="btn btn-teal btn-file uid-otp-validate uidotp <%=uidotp%>">Validate<i class="ph-vault ms-2"></i></button>
            </div>
        </div>
    </div>
  </div>
    ...
    <div class="row mb-3 nresdiv <%=res_stat.equals("N")?"":"hide"%> ">
        <div class="border-bottom pb-2 mb-2">
            <span class="fw-bold">VISA/OCI/CDC Details</span>
        </div>
        <div class="row">
            <div class="col-lg-6">

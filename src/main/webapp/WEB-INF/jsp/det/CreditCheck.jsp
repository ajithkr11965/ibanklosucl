  ...
  if(applicant!=null) {
    ...
    if (credit != null) {
     vlFinliabList = credit.getVlLiabList().stream()
      ...
      expTenure=credit.getExpTenure()==null?"":credit.getExpTenure().toString();
      expLoanAmt=credit.getExpLoanAmt()==null?"":credit.getExpLoanAmt().toString();
    ...
    <div class="row  mt-3">
      ...
      <div class="col-lg-6 d-flex justify-content-center" style="align-items: center;">
        <div class="row">
          <div class="col-lg-4">
            <div class="mb-2">
              <label class="form-label">Expected Loan Amout (in Rs/-).</label>
              <div class="form-control-feedback form-control-feedback-start">
                <input type="number" class="form-control expLoanAmt" placeholder="" name="expLoanAmt" value="<%=expLoanAmt%>">
                <div class="form-control-feedback-icon">
                  <i class="ph-money  text-muted"></i>
                </div>
              </div>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="mb-2">
              <label class="form-label">Expected Loan Tenure(Months).</label>
              <div class="form-control-feedback form-control-feedback-start">
                <div class="form-control-feedback form-control-feedback-start">
                  <input type="number" class="form-control exptenure" placeholder="" name="exptenure" value="<%=expTenure%>">
                </div>
              </div>
            </div>
          </div>
  ...
  <div class="row d-flex justify-content-center crchk-inc" style="<%= "done".equals(crchk) ? "" : "display:none !important" %>" name="crchk-inc-lia">
    ...
    <div class="row mb-6">
      <div class="col-lg-6">
        ...
        <div class="form-control-feedback form-control-feedback-start">
          <input type="number" pattern="[0-9]*" step="1" min="0" onchange="validateDecimal(this)" class="form-control" name="liabilityAsPerPayslip" id="liabilityAsPerPayslip"
    ...
    <div id="emptable-sal-div-id" class="table-responsive border-white border-opacity-15  crchk-inc-lia-div">
      ...
      <table class="table table-bordered crchk-inc-lia-table"  >
        ...
        <tbody class="crchk-inc-lia-table-body" name="crchk-inc-lia-table-body">
          ...
          <td><input type="number" onchange="validateDecimal(this)" name="lianaturelimit" id="lianaturelimit" class="form-control"  placeholder="Enter Nature of Limit"></td>
          <td><input type="number" onchange="validateDecimal(this)" name="lialimit" id="lialimit" class="form-control"  placeholder="Enter Limit"></td>
          <td><input type="number" onchange="validateDecimal(this)" name="liaoutstanding" id="liaoutstanding" class="form-control"  placeholder="Enter Outstanding"></td>
          <td><input type="number" onchange="validateDecimal(this)" name="liaemi" id="liaemi" class="form-control"  placeholder="Enter EMI"></td>
           <td><input type="number" onchange="validateDecimal(this)" name="liamodifiedemi" id="liamodifiedemi" class="form-control" placeholder="Enter Modified EMI"></td>
<%--          <td>--%>
...
<%--          </td>--%>
          ...
          <tr>
            ...
            <td><input type="number" onchange="validateDecimal(this)" name="lianaturelimit" id="lianaturelimit" class="form-control" placeholder="Enter Nature of Limit" value="<%=vlliab.getNatureLim()%>" readonly></td>
            <td><input type="number" onchange="validateDecimal(this)" name="lialimit" id="lialimit" class="form-control" placeholder="Enter Limit" value="<%=vlliab.getLimit()%>" readonly></td>
            <td><input type="number" onchange="validateDecimal(this)" name="liaoutstanding" id="liaoutstanding" class="form-control" placeholder="Enter Outstanding" value="<%=vlliab.getOutStanding()%>" readonly></td>
            <td><input type="number" onchange="validateDecimal(this)" name="liaemi" id="liaemi" class="form-control" placeholder="Enter EMI" value="<%=vlliab.getEmi()%>" readonly></td>

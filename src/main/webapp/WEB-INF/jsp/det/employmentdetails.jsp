                    ...
                    <div style="border: 3px dotted #eee;border-radius: 15px !important;background: #f8f9fb;" class="borders rounded  border-dashed  ">
                        <div class="list-feed list-feed-solid ms-3 mt-3 mb-3">
                            ...
                            <div class="list-feed-item mb-4 me-3 border-dark">
                                <input type="text" class="form-control"  name="emp-retage" placeholder="Enter Retirement Age" value="<%=(employment !=null && employment.getRetirement_age() !=null) ? employment.getRetirement_age() : ""%>">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div id="emptable-sal-div-id" class="table-responsive border-white border-opacity-15 mb-3 emptable-sal-div">
                    <table class="table table-bordered emptable-sal-pen"  >
                        ...
                        <tr>
                            ...
                            %>
                            <tr>
                            <td><input type="text" name="empname" id="empname" class="form-control required" value="<%=(vlEmployment.getEmployerName() !=null) ? vlEmployment.getEmployerName() : "" %>"></td>
                            <td><input type="text" name="empaddress" id="empaddress" class="form-control required"  value="<%=(vlEmployment.getEmployerAddress() !=null) ? vlEmployment.getEmployerAddress() : ""%>"></td>
                            <td><input type="text" name="empworkexp" id="empworkexp" class="form-control empworkexp-sal required"  value="<%=(vlEmployment.getWorkExperience() !=null) ? vlEmployment.getWorkExperience() : ""%>"></td>
...
<%--                                </select>--%>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="empothcode" id="empothcode" class="form-control" value="<%=(vlEmployment.getOccupationCode() !=null) ? vlEmployment.getOccupationCode() : ""%>" readonly>
<%--                                <select name="empothcode" id="empothcode" class="form-control select ">--%>
<%--                                    <option value="">Please Select</option>--%>
...
<%--                                </select>--%>
                            ...
                            <td><input type="text" name="empothname" id="empothname" class="form-control"  placeholder="Enter Name" value="<%=(vlEmployment.getEmployerName() !=null) ? vlEmployment.getEmployerName() : ""%>"></td>
                            <td><input type="text" name="empothwrk" id="empothwrk" class="form-control empworkexp-oth"  placeholder="Enter Experience" value="<%=(vlEmployment.getBusinessExperience() !=null) ? vlEmployment.getBusinessExperience() : ""%>"></td>
                            <td>
                                <button type="button" onclick="deleteRowEmp(this,'OTH')" class="btn btn-flat-danger border-transparent btn-sm emptable-addbtn btn-file">
                                    <i class="ph-trash"></i>
                                </button>

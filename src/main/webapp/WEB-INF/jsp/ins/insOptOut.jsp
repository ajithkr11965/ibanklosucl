...
<div class="page-content pt-0">
    <%request.setAttribute("TAB", "INSOPTOUT");%>
                            ...
                            <div class="card card-xl-stretch mb-5 mb-xl-8">
                                ...
                                <div class="card-body py-3">
                                    <div class="table-responsive">
                                        <form name="wilist" id="wilist" method="post" action="insOut">
                                            ...
                                            <table class="table align-middle table-row-dashed fs-8 gy-3" id="branch-maker-queue-details-table">
                                                ...
                                                <%
                                                    ...
                                                    List<VehicleLoanMasterDTO> insQueue = (List<VehicleLoanMasterDTO>) request.getAttribute("insQueue");
                                                    int count = 1;
                                                    for (VehicleLoanMasterDTO item : insQueue) {
                                                        String lockDetails = "";

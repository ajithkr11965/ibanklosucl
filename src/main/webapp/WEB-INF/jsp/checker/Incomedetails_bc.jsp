							...
							<%
								if (vehicleLoanFDList != null && !vehicleLoanFDList.isEmpty()) {
									...
									tableHtml += "<table class='table table-xs table-bordered'>" +
											"<tr><th>FD A/C</th><th>Account Status</th><th>Account Type</th><th>Account Open Date</th><th>Maturity Date</th><th>Deposit Amount</th><th>Deposit Amount Available</th><th>FSLD Adj</th><th>Available Balance</th><th>Eligible</th></tr>";

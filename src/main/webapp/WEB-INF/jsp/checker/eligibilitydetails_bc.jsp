...
%>
    ...
    <ul class="nav-group-sub " id="">
      <!-- Eligibility Details -->
      <li class="nav-item show" id="checkEligibilityItems">
        <div class="row">
          <div class="col-lg-4">
            <div class="mb-3 mt-3">
              <div class="row">
            ...
            <div class="mb-3 mt-3">
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="col-lg-12 form-control-feedback form-control-feedback-start">
                    <input type="number" id="add-ltv-amount" class="form-control"  value="<%= addltvAmount %>"  readonly>
                  </div>
                </div>
              </div>
            </div>
                        ...
                        <div class="mb-3 mt-3">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-lg-12 form-control-feedback form-control-feedback-start">
                                        <input type="text" id="loan-amount-recommend" class="form-control" value="<%= loanAmountRecommended %>" placeholder="Enter recommended loan amount">
                                    </div>
                                </div>
                            </div>
                        </div>
              ...
              <div class="mb-3 mt-3">
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="col-lg-12 form-control-feedback form-control-feedback-start">
                      <input type="number" min="" id="dealter-loan-amount" class="form-control" value="<%= dealerAmt %>"  readonly>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="mb-3 mt-3">
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="col-lg-12 form-control-feedback form-control-feedback-start">
                      <input type="number" min="" id="ins-loan-amount" class="form-control" value="<%= insAmt %>"   readonly>
                    </div>
                  </div>
                </div>
              </div>

  ...
  <div class="container-fluid">
    ...
    <div class="navbar-collapse collapse order-2 order-lg-1" >
								<span class="navbar-text d-none d-lg-inline-flex align-items-lg=center me-3">
									...
									Branch : <b><%=userdt.getJoinedSol()%>(<%=sol_desc%> <%=roname%>)</b>
								</span>
    </div>
    ...
    <div class="content">
      ...
      <div class="d-flex flex-row min-vh-100">
        <div id="appList" class="w-100">
          ...
          <div class="w-100 kt">
            <form id="wicrtamberform" class="z-index-0"  action="wicrtambersave">
                    ...
                    <div class="1"  style="background: #fff !important;">
                      ...
                      <div class="rounded border p-2 mb-3">
                        ...
                        <div class="text-center">
                          <button type="button"  class="btn btn-sm btn-primary ms-1 me-1 backbtn">Back </button>
<%--                          <button type="button" id="caapprovebtn" class="btn btn-sm btn-success crtcasubmit ms-1 me-1 ">Approve<i class="ph-paper-plane-tilt ms-2"></i></button>--%>
<%--                          <button type="button" id="casendbackbtn" class="btn btn-sm btn-warning crtcasubmit ms-1 me-1 ">Send Back<i class="ph-paper-plane-tilt ms-2"></i></button>--%>
<%--                          <button type="button" id="carejectbtn" class="btn btn-sm btn-danger crtcasubmit ms-1 me-1 ">Reject <i class="ph-paper-plane-tilt ms-2"></i></button>--%>
                        </div>
...
<script src="assets/js/custom/wienquiryfetch.js"></script>

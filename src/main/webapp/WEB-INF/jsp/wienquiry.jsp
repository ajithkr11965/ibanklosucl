    ...
    <div class="kt">
      <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-0 ms-3 mb-3 mt-1">
        ...
        <div class="d-flex align-items-center mt-2 mb-2">
          ...
          <div data-kt-countup="true" data-kt-countup-value="15000" data-kt-countup-prefix="$" data-kt-initialized="1" class="fs-8  fw-bold counted ms-2">Inquiry Page</div>
        </div>
        <!--end::Number-->
        <!--begin::Label-->
        <!--end::Label-->
...
<div class="page-content pt-0">
  <%request.setAttribute("TAB","WIENQUIRY");%>
  ...
  <div class="content-wrapper">
    <div class="content">
      <div class="row">
        ...
        <form name="wienquiryfrm" id="wienquiryfrm" method="post" action="wibogassets">
                ...
                <div class="card card-xl-stretch mb-5 mb-xl-8 table-shadow">
                  ...
                  <div class="card-body py-3">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-3">
                        <input type="text" id="winum" name="winum" placeholder="Enter WI" class="form-control col-sm-3">
                      </div>
                      <div class="col-sm-3">
                        <input type="submit" name="submit" class="btn btn-primary" id="wienqbtn">View details</input>
                      </div>
                    </div>

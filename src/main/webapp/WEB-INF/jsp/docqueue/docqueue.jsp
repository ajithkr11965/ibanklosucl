    ...
    <div class="navbar-collapse collapse order-2 order-lg-1" >
								<span class="navbar-text d-none d-lg-inline-flex align-items-lg=center me-3">
                                  ...
                                  <input type="hidden" id="bpmerror" value="<%=bpmerr%>"/>
                                    ...
                                    <input type="hidden" id="brHead" value="<%=brHead%>"/>
                    ...
                    <div class="card">
                        ...
                        <div class="tab-content card-body" id="loanbody">
                            ...
                            <div class="tab-pane fade active show" id="tab-A" role="tabpanel">
                                ...
                                %>
                                <jsp:include page="generaldetails_bd.jsp">
                                    <jsp:param name="apponly" value="Y"/>
                                </jsp:include>
                                <jsp:include page="kycdetails_bd.jsp" />
                                <jsp:include page="basicdetails_bd.jsp" />
                                <jsp:include page="employmentdetails_bd.jsp" />
                                <jsp:include page="Incomedetails_bd.jsp" />
                                <jsp:include page="CreditCheck_bd.jsp" />
                            </div>
                            <%
                            }
                            else if ("C".equals(applicant.getApplicantType())) {
                                        ...
                                        <div class="1"  style="background: #fff !important;">
                                            ...
                                            <div class="rounded border p-2 mb-3">
                                                ...
                                                <div class="accordion accordion-icon-collapse" id="vl_bd_int" data-state="2">
                                                    ...
                                                    <jsp:include page="vehicledetails_bd.jsp" />
                                                    <jsp:include page="loandetails_bd.jsp" />
                                                    <jsp:include page="eligibilitydetails_bd.jsp" />
                                                    <jsp:include page="racescoredetails_bd.jsp" />
                                                    <jsp:include page="validationdetails_bd.jsp" />
                                                    <jsp:include page="hunterdetails_bd.jsp" />
                                                    <jsp:include page="blacklistdetails_bd.jsp" />
                                                    <jsp:include page="deviationdetails_bd.jsp" />
                                                    <jsp:include page="sanction_bd.jsp" />
                                                       <%
                                                           long cifCount=vehicleLoanMaster.getApplicants().stream().filter(t->t.getSibCustomer().equalsIgnoreCase("N") && t.getDelFlg().equalsIgnoreCase("N")).count();
                                                       if(cifCount>0){
                                                       %>
                                                        <jsp:include page="bogcif_bd.jsp" />
                                                        <%
                                                            }
                                                        %>
                                                    <jsp:include page="repayment_bd.jsp" />
                                                        <jsp:include page="roiwaiver_bd.jsp" />

                                                        <jsp:include page="processingfee_bd.jsp" />


                                                    <jsp:include page="decision_bd.jsp" />

                                                     <%
//                                                        boolean roiPending=false;
//                                                        boolean chrPending=false;
...
//                                                                 roiPending=true;
//                                                             }
//                                                             Optional<VehicleLoanSubqueueTask> chrg_=subqueueTask.stream().filter(t->t.getTaskType().equalsIgnoreCase("CHARGE_WAIVER")).findFirst();
//                                                             if(chrg_.isPresent()){
//                                                                 chrPending=true;
//                                                             }
//                                                         }
//
//                                                     if(vehicleLoanMaster.getRepaymentStatus()!=null && vehicleLoanMaster.getRepaymentStatus() && !roiPending && !chrPending)
//                                                     {
                                                     %>
                                                        <jsp:include page="docsub_bd.jsp" />
                                                    <%
//                                                     }
                                                    %>
                                                </div>
...
<%--                <input type="hidden" id="pdfBase64" value="<%=request.getAttribute("sancLetter").toString()%>">--%>
                ...
                <div class="p-5 text-center">
                    <div class="card-header">
                        <h5 class="mb-2 text-success"> Whether any sanction modification required?</h5>
                    </div>
                    <div class="checkbox-wrapper-16">

                        <label class="checkbox-wrapper">
                            <input class="checkbox-input"  id="Enable" name="Activity" type="radio" value="Y" <%=vehicleLoanMaster.getSancModRequired()!=null && vehicleLoanMaster.getSancModRequired()?"checked":""%> >
                        ...
                        <label class="checkbox-wrapper pl-2">
                            <input class="checkbox-input" id="Disable" name="Activity" type="radio" value="N"   <%=vehicleLoanMaster.getSancModRequired()!=null && !vehicleLoanMaster.getSancModRequired()?"checked":""%>>
                            <span class="checkbox-tile">
                                                  <span class="checkbox-icon">
                                                  </span>
...
<%--                        <div class="text-danger pt-1"><span class="text-red fw-bold"><i class="ph-info ph pe-2 "></i>Kindly select above</span></div>--%>
                        <div class="text-end pt-1 kt">
                            <button type="button" id="sancProceed" class="btn btn-lg btn-primary" data-kt-stepper-action="next">Proceed

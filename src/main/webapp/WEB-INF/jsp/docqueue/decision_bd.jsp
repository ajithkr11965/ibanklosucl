    ...
    $("#bdsave").on('click',function (e){
      ...
      var dto = {
        ...
        completeDto: {
          slno: $('#slno').val(),
          wiNum: $('#winum').val(),
          docRemarks: $('#bdremarks').val(),
          decision: $('#bddecision').val()
        }
      };
          ...
          <div id="kt_docs_repeater_basic">
            <form id="bd_decision" name="bd_decision" class="form" method="POST">
              ...
              <div class="mb-10 pt-5 fv-row fv-plugins-icon-container">
                ...
                <!--end::Label-->
                <!--begin::Input-->
                <select name="bddecision" id="bddecision" class="form-select form-select-solid decision" >
                  <option value="" >select</option>
                  <option value="BS" >Send Back</option>
                  <option value="NIL" >Reject</option>

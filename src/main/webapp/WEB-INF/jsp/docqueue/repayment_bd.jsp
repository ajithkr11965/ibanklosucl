    ...
    <div class="accordion-header d-flex collapsed  " data-bs-toggle="collapse" id="decisionDetailslink" data-bs-target="#repayDetailsContent">
      <label class="btn btn-outline btn-outline-dashed btn-active-light-primary acdlen justify-content-start  p-5 d-flex align-items-center mb-2"
        ...
        <span class="d-block fw-semibold text-start">
                    <span class="text-gray-900 fw-bold d-block fs-4">NACH/Borrower operative Account for Repayment</span>
                    <span class="text-muted fw-semibold fs-7">
                     Enter Repayment details for setting up auto debit.
                    </span>
                </span>
      </label>
    </div>
          ...
          <div id="kt_docs_repeater_basic">
            <form id="bankDetailsForm" name="bankDetailsForm" method="POST">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="accountNumber" name="accountNumber" required value="<%=repaymentAccno%>" />
              </div>

              <!-- IFSC Code -->
              <div class="mb-3">
                <label for="ifscCode" class="form-label">IFSC Code</label>
                <input type="text" class="form-control" id="ifscCode" name="ifscCode" minlength="11" maxlength="11" required value="<%=ifsc%>" />
              </div>

              <!-- Borrower Name -->
              <div class="mb-3">
                <label for="borrowerName" class="form-label">Borrower Name</label>
                <input type="text" class="form-control" id="borrowerName" name="borrowerName" required value="<%=borrowerName%>" />
              </div>

            </form>
            <div class="text-end pt-5">
              <button type="button" id="repsaveBtn" class="btn btn-lg btn-primary" data-kt-stepper-action="next">Save

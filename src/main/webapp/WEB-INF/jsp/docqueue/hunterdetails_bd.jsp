    ...
    <tbody>
        ...
        <tr class="table-row-gray-400">
            ...
            <td class="text-gray-800 text-hover-primary fs-7 fw-bold">
                <%=applicant.getBasicapplicants().getApplicantName()%>
            </td>
            <td class="runDate">
                <%= vlHunterDetails != null && vlHunterDetails.getApplicantId().equals(applicant.getApplicantId())
                    ? dateFormat.format(vlHunterDetails.getTimestamp()) : "" %>
            </td>
            <td class="score">
                <%= vlHunterDetails != null && vlHunterDetails.getApplicantId().equals(applicant.getApplicantId())
                    ? vlHunterDetails.getScore() : "" %>
            </td>
            ...
            <td class="decision">
                <%= vlHunterDetails != null && vlHunterDetails.getApplicantId().equals(applicant.getApplicantId())
                    ? (vlHunterDetails.getHunterUserRemarks() != null ? vlHunterDetails.getHunterUserRemarks() : "NA") : "NA" %>
            </td>
            <td class="status">
                <%= vlHunterDetails != null && vlHunterDetails.getApplicantId().equals(applicant.getApplicantId())
                    ? (vlHunterDetails.getHunterUserRemarks() != null ? "Allowed"
                       : (vlHunterDetails.getMatches() > 0 ? "FAILED" : "PASS")) : "" %>
            </td>
            <td class="reviewUser">
                <%= vlHunterDetails != null && vlHunterDetails.getApplicantId().equals(applicant.getApplicantId())
                    ? vlHunterDetails.getReviewUser() : "" %>
            </td>
            <td class="reviewDate">
                <%= vlHunterDetails != null && vlHunterDetails.getApplicantId().equals(applicant.getApplicantId())
                    ? (vlHunterDetails.getReviewDate() != null ? dateFormat.format(vlHunterDetails.getReviewDate()) : "") : "" %>
            </td>
        </tr>
        <%
                }

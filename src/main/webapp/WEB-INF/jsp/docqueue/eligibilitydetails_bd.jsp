...
<%
  ...
  String addltvAmount = details.getAddLtvAmt() != null ? details.getAddLtvAmt().toString() : "-";
	...
	String loanAmountRecommended =details.getLoanAmountRecommendedCPC()!=null? details.getLoanAmountRecommendedCPC().toString():"";
 String dealerAmt = details.getDealerAmt() != null ? details.getDealerAmt().toString() : "-";
  String insAmt = details.getInsAmt() != null ? details.getInsAmt().toString() : "-";
	String loanRoiRecommended = details.getRoiRecommendedCPC()!=null? details.getRoiRecommendedCPC().toString():"";
	String sancLoan=details.getLoanAmountRecommendedCPC()!=null? details.getLoanAmountRecommendedCPC().toString():details.getSancAmountRecommended()!=null? details.getSancAmountRecommended().toString():"";
	...
	<div class="w-100">
		...
		<div id="eligibilityDetailsContent" class="fs-6 collapse  ps-10 " data-bs-parent="#vl_rm_int">
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="col-lg-12 form-control-feedback form-control-feedback-start">
									<input type="text" id="vehicle-eligible-amount" class="form-control" value="<%= vehicleAmount %>" readonly>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="mb-3 mt-3">
						<div class="row">
							<div class="col-md-12">
								...
								<div class="col-lg-12 form-control-feedback form-control-feedback-start">
									<input type="text"  id="ltv-percent" class="form-control" value="<%= ltvPercent %>" placeholder="Enter LTV Percent" max="100" min="0.01" step="0.01">
								</div>
							</div>
						</div>
					</div>
					...
					<div class="mb-3 mt-3">
						<div class="row">
							<div class="col-md-12">
								...
								<div class="col-lg-12 form-control-feedback form-control-feedback-start">
									<input type="text" id="ltv-amount" class="form-control" value="<%= ltvAmount %>" readonly>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="mb-3 mt-3">
						<div class="row">
							<div class="col-md-12">
								...
								<div class="col-lg-12 form-control-feedback form-control-feedback-start">
									<input type="text" id="requested-loan-amount" class="form-control" value="<%= loanAmount %>" readonly>
								</div>
							</div>
						</div>
					</div>
            ...
            <div class="mb-3 mt-3">
              <div class="row">
                <div class="col-md-12">
                  <div class="fw-semibold">Additional LTV</div>
                  <div class="col-lg-12 form-control-feedback form-control-feedback-start">
                    <input type="text" id="add-ltv-amount" class="form-control"  value="<%= addltvAmount %>"  readonly>
                  </div>
                </div>
              </div>
            </div>
					...
					<div class="mb-3 mt-3">
						<div class="row">
							<div class="col-md-12">
								...
								<div class="col-lg-12 form-control-feedback form-control-feedback-start">
									<input type="text" id="eligible-tenor" class="form-control" value="<%= tenor %>" readonly>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="row">
					...
					<div class="mb-3 mt-3">
						<div class="row">
							<div class="col-md-12">
								...
								<div class="col-lg-12 form-control-feedback form-control-feedback-start">
									<input type="text" id="program-eligible-amount" class="form-control" value="<%= programEligibleAmount %>" readonly>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="mb-3 mt-3">
						<div class="row">
							<div class="col-md-12">
								...
								<div class="col-lg-12 form-control-feedback form-control-feedback-start">
									<input type="text" id="eligible-loan-amount" class="form-control" value="<%= eligibleLoanAmount %>" readonly>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="mb-3 mt-3">
						<div class="row">
							<div class="col-md-12">
								...
								<div class="col-lg-12 form-control-feedback form-control-feedback-start">
									<input type="text" min="" id="dealter-loan-amount" class="form-control" value="<%= dealerAmt %>"  readonly>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="mb-3 mt-3">
						<div class="row">
							<div class="col-md-12">
								...
								<div class="col-lg-12 form-control-feedback form-control-feedback-start">
									<input type="text" min="" id="ins-loan-amount" class="form-control" value="<%= insAmt %>"   readonly>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="mb-3 mt-3">
						<div class="row">
							<div class="col-md-4">
								...
								<div class="col-lg-12 form-control-feedback form-control-feedback-start">
									<input type="text" id="card-rate" class="form-control" value="<%= cardRate %>" readonly>
								</div>
							</div>
							<div class="col-md-4">
								<div class="fw-semibold">EMI  ( in Rs)</div>
								<div class="col-lg-12 form-control-feedback form-control-feedback-start">
									<input type="text" id="emi" class="form-control" value="<%= emi %>" readonly>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="col-lg-12">
					<div class="mb-3 mt-3">
						<div class="row">
							<div class="col-md-4">
								<div class="fw-semibold">Card Rate (Sanctioned)</div>
								<div class="col-lg-12 form-control-feedback form-control-feedback-start">
									<input type="text" id="card-rate-cpc" class="form-control" value="<%= sancRoi %>" readonly>
								</div>
							</div>
							<div class="col-md-4">
								<div class="fw-semibold"> Loan Amount (Sanctioned)</div>
								<div class="col-lg-12 form-control-feedback form-control-feedback-start">
									<input type="text"  class="form-control" value="<%= sancLoan %>" readonly>
								</div>
							</div>
						</div>
					</div>

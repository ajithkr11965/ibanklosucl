                ...
                <div id="appList" class="w-100">
                    ...
                    <div class="card">
                        ...
                        <ul class="nav nav-tabs nav-tabs-underline nav-justified mb-0" role="tablist" id="loanapp">
                            ...
                            %>
                            <li class="nav-item" role="presentation"><a href="#tab-A" class="nav-link apptype active  alert alert-primary  text-white " data-bs-toggle="tab" aria-selected="false" role="tab" tabindex="-1" data-app="A"><i class="ph-user text-white fw-semibold"></i>APPLICANT</a></li>
                            <%
                            } else if ("C".equals(applicant.getApplicantType())) {
                            %>
                            <li class="nav-item" role="presentation"><a href="#tab-C-<%=coApplicantCount%>" class="nav-link apptype   alert alert-primary  text-white " data-bs-toggle="tab" aria-selected="false" role="tab" tabindex="-1" data-app="C-<%=coApplicantCount%>"<i class="ph-user-circle-plus text-black"></i><span data-applicationtype="C">Co-Applicant-<%=coApplicantCount%></span>
                            </a>
                            </li>
                            <%
                                coApplicantCount++;
                        ...
                        <div class="tab-content card-body" id="loanbody">
                            ...
                            <div class="tab-pane fade active show" id="tab-A" role="tabpanel">
                                ...
                                %>
                                <jsp:include page="allotview/generaldetails_allot.jsp">
                                    <jsp:param name="apponly" value="Y"/>
                                </jsp:include>
                                <jsp:include page="allotview/kycdetails_allot.jsp" />
                                <jsp:include page="allotview/basicdetails_allot.jsp" />
                                <jsp:include page="allotview/employmentdetails_allot.jsp" />
                                <jsp:include page="allotview/Incomedetails_allot.jsp" />
                                <jsp:include page="allotview/creditcheck_allot.jsp" />
                            </div>
                            <%
                            }
                            else if ("C".equals(applicant.getApplicantType())) {
                        ...
                        <div class="card-group-vertical">
                            <div class="card border shadow-none">
                                ...
                                <div id="vehDetailsContent"  class="collapse" style="">
                                    <div class="card-body">
                                        <jsp:include page="allotview/vehicledetails_allot.jsp" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card border shadow-none">
                                ...
                                <div id="loanDetailsContent"class="collapse" style="">
                                    <div class="card-body">
                                        <jsp:include page="allotview/loandetails_allot.jsp" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card border shadow-none">
                                ...
                                <div id="eligibilityDetailsContent"  class="collapse show" style="">
                                    <div class="card-body">
                                        <jsp:include page="allotview/eligibilitydetails_allot.jsp" />
                                    </div>
                                </div>
                            </div>
                        </div>

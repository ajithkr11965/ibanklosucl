      ...
      <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-0 ms-3 mb-3 mt-1">
        <div class="d-flex align-items-center mt-2 mb-2">
          <div class="d-flex flex-center w-25px h-25px rounded-3 bg-light-primary bg-opacity-90 me-3">
            <i class="ki-duotone  ki-document text-primary fs-3x"><span class="path1"></span><span class="path2"></span></i>                </div>
          <div data-kt-countup="true" data-kt-countup-value="15000" data-kt-countup-prefix="$" data-kt-initialized="1" class="fs-8  fw-bold counted ms-2">Branch Documentation Queue</div>
        </div>
      </div>
    </div>
              ...
              <div class="card card-xl-stretch mb-5 mb-xl-8">
                ...
                <div class="card-body py-3">
                  <div class="table-responsive">
                    <form name="wimultipleDisbDiv" id="wibmlist" method="post" action="docqueue">
                      <input type="hidden" name="slno" value="" id="slnoInput">
                      <input type="hidden" name="action" value="BD" id="action_mod">
                      <table class="table align-middle table-row-dashed fs-8 gy-3" id="branch-maker-queue-details-table">
                        ...
                        <%
                          ...
                          List<VehicleLoanMasterDTO> entryQueue = (List<VehicleLoanMasterDTO>) request.getAttribute("bdQueue");
                          int count = 1;

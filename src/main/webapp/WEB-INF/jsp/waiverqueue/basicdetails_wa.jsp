...
<%
    ...
    String basic_name ="",basic_dob="",basic_gender="",basic_ftname="",basic_mtname="",basic_spname="",basic_saltutation="",basic_crmlead="",basic_ms="",basic_mob="",basic_email="",basic_mobcode="91";
    String permanentAddress1="",permanentAddress2="",permanentAddress3="",permanentCity="",permanentState="",permanentCountry="",permanentPin="",permanentDurationOfStay="",permanentResidenceType="",presentAddress1="",presentAddress2="",presentAddress3="",presentCity="",presentState="",presentCountry="",presentPin="",presentDurationOfStay="",presentResidenceType="",preferred_flag="",current_residence_flag="",sameAsper="N",comm_proof_flg="N";

    String  presentCitydesc="",presentCountryDesc="",presentStatedesc="",permanentCitydesc="",permanentStatedesc="",permanentCountrydesc="";

    String permanentdisbaled="" ,basic_edu="",basic_pep="",editable="noneditable",commEditable="";
    if(applicant!=null)
    {
    ...
    <div class="row mb-3">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="mb-2">
                    ...
                    <div class="form-control-feedback form-control-feedback-start">
                        <%=basic_crmlead.isBlank()?"-NIL-":basic_crmlead%>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="mb-2">
                    ...
                    <div class="d-flex">
                        <div class="col-md-3">
                            <select class="form-control form-select basic_mobcode" name="basic_mobcode" value="<%=basic_mobcode%>">
                                <%
        ...
        <div class="table-responsive border rounded">
            <table class="table">
                ...
                <tr>
                    <td class="w-50">
                        Address1: <input type="text" name="permanentAddress1"  class="form-control permanentAddress1" value="<%=permanentAddress1%>" <%=permanentdisbaled%> >
                    </td>
                    <td>
                        Address1: <input type="text" class="form-control presentAddress1" name="presentAddress1"  value="<%=presentAddress1%>">
                    </td>
                </tr>
                <tr>
                    <td class="w-50">
                        Address2: <input type="text" name="permanentAddress2"  class="form-control permanentAddress2" value="<%=permanentAddress2%>" <%=permanentdisbaled%> >
                    </td>
                    <td>
                        Address2: <input type="text" class="form-control presentAddress2" name="presentAddress2"  value="<%=presentAddress2%>" >
                    </td>
                </tr>
                <tr>
                    <td class="w-50">
                        Address3: <input type="text" name="permanentAddress3"  class="form-control permanentAddress3" value="<%=permanentAddress3%>"  <%=permanentdisbaled%>>
                    </td>
                    <td>
                        Address3: <input type="text" class="form-control presentAddress3" name="presentAddress3"  value="<%=presentAddress3%>">
                    </td>
                </tr>

                <tr>
                    <td class="w-50">
                        PIN: <input type="text" name="permanentPin" class="form-control pincode permanentPin" value="<%=permanentPin%>" <%=permanentdisbaled%>>
                    </td>
                    <td>
                        PIN: <input type="text" name="presentPin" class="form-control pincode presentPin" value="<%=presentPin%>"><br>
                    </td>
                </tr>
                <tr>
                    <td class="w-50">
                        City: <select name="permanentCity" class="form-control form-select permanentCity basic_city" <%=permanentdisbaled%>>
                        <%
                    ...
                    <td>
                        City: <select name="presentCity"    class="form-control form-select presentCity basic_city">
                        <%
                            if(presentCity!=null){
                ...
                <tr>
                    <td class="w-50">
                        <select name="permanentState" class="form-control form-select permanentState basic_state" <%=permanentdisbaled%>>
                            State:  <%
                    ...
                    <td>
                        State:
                        <select name="presentState"   class="form-control form-select presentState basic_state">
                            <%
                ...
                <tr>
                    <td class="w-50">
                        Country:
                        <select name="permanentCountry" class="form-control form-select permanentCountry basic_country" <%=permanentdisbaled%>>
                            <%
                    ...
                    <td>
                        Country: <select name="presentCountry"   class="form-control form-select presentCountry basic_country">
                        <%
                ...
                <tr>
                    <td class="w-50">
                        Duration of stay (in months): <input type="number" name="permanentDurationOfStay" class="form-control permanentDurationOfStay" value="<%=permanentDurationOfStay%>">
                    </td>
                    <td>
                        Duration of stay (in months): <input type="number" class="form-control presentDurationOfStay"  name="presentDurationOfStay" value="<%=presentDurationOfStay%>">
                    </td>
                </tr>
                <tr>
                    <td class="w-50">
                        Residence type: <select name="permanentResidenceType" class="form-control form-select permanentResidenceType" >
                        <%
                            List<Misrct> residenceTypes = (List<Misrct>) request.getAttribute("residenceTypes");
                            for (Misrct residenceType : residenceTypes) {
                                out.println("<option value=\"" + residenceType.getCodevalue() + "\" "+(residenceType.getCodevalue().equals(permanentCity) ? "selected" : "" )+" >" + residenceType.getCodedesc()  + "</option>");
                            }
                        %>
                    </select>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <label>
                            <input type="file" name="comm_proof"  class="form-control comm_proof"> Communication Address Proof

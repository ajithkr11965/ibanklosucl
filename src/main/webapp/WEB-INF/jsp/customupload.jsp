...
<head>
    <meta charset="UTF-8">
    <title>Document Upload Queue</title>
    <meta charset="utf-8">
    ...
    <script src="assets/js/custom/customupload.js"></script>
        ...
        <div class="kt">
            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-0 ms-3 mb-3 mt-1">
                ...
                <div class="d-flex align-items-center mt-2 mb-2">
                    ...
                    <div data-kt-countup="true" data-kt-countup-value="15000" data-kt-countup-prefix="$" data-kt-initialized="1" class="fs-8  fw-bold counted ms-2">Custom document upload</div>
                </div>
                <!--end::Number-->
                <!--begin::Label-->
                <!--end::Label-->
...
<div class="page-content pt-0">
    <%request.setAttribute("TAB","CUSTDOC");%>
                            ...
                            <div class="card card-xl-stretch mb-5 mb-xl-8 table-shadow">
                                ...
                                <div class="card-body py-9">
                                    <div class="row mb-6">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" id="winum" placeholder="Enter WI" class="form-control col-sm-6" required>
                                        </div>

                                    </div>
                                    <div class="row mb-6">
                                            <label class="col-form-label col-sm-3" for="foldername">Folder:</label>
                                            <div class="col-sm-6">
                                                <select id="foldername" class="form-control col-sm-6" required> </select>
                                            </div>

                                        </div>
                                            <div class="row mb-6">
                                                <label class="col-form-label col-sm-3" for="filename">Browse file:</label>
                                                <div class="col-sm-6">
                                                    <input type="file" id="fileInput" placeholder="" class="form-control col-sm-6" required>
                                                </div>
                                    ...
                                    <div class="row mb-6">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" id="remarks" placeholder="Enter remarks" class="form-control col-sm-6">
                                        </div>
                                        <div class="col-sm-3">
                                            <a href="#" class="btn btn-primary" id="custdocbtn">Upload</a>
                                        </div>
                                    </div>
                                </div>
                            </div>

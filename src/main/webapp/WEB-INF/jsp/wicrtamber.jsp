                  ...
                  <div class="1 w-100 border rounded mb-lg-4 p-0">
                    <div class="1"  style="background: #fff !important;">
                      ...
                      <div class="rounded border p-2 mb-3">
                        ...
                        <button type="button" id="caapprovebtn" class="btn btn-sm btn-success crtcasubmit ms-1 me-1 crtamberbtn">Approve<i class="ph-paper-plane-tilt ms-2"></i></button>
                        <button type="button" id="casendbackbtn" class="btn btn-sm btn-warning crtcasubmit ms-1 me-1 crtamberbtn">Send Back<i class="ph-paper-plane-tilt ms-2"></i></button>
                        <button type="button" id="carejectbtn" class="btn btn-sm btn-danger crtcasubmit ms-1 me-1 crtamberbtn">Reject <i class="ph-paper-plane-tilt ms-2"></i></button>

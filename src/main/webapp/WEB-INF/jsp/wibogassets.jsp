                                        ...
                                        <div class="1"  style="background: #fff !important;">
                                            ...
                                            <div class="rounded border p-2 mb-3">
                                                ...
                                                <div class="accordion accordion-icon-collapse" id="vl_rc_int" data-state="2">
                                                    ...
                                                    <jsp:include page="bogassets/vehicledetails_ac.jsp" />
...
<%--                                                        <jsp:include page="bogassets/sanmodification_ac.jsp" />--%>
                                                        <jsp:include page="bogassets/acctlabels.jsp" />
                                                        <jsp:include page="bogassets/accopening.jsp" />
                                                        <jsp:include page="bogassets/nachmandate.jsp" />
                                                         <jsp:include page="bogassets/lienmarking_ac.jsp" />
                                                        <jsp:include page="bogassets/disbursement.jsp" />
                                                        <jsp:include page="bogassets/Neft.jsp" />
...
//addCoApplicantBtn.prop('disabled', true);
    ...
    if(activeTab == 'rmk'){
        scrollToDiv='decisionDetailslink';
    }else if(activeTab == 'neft'){
        scrollToDiv='neftlink';
    }else if(activeTab == 'disb'){
        scrollToDiv='disblink';
    }else if(activeTab == 'nach'){
        scrollToDiv='nachtableDetails';
    }else if(activeTab == 'acopn'){
        scrollToDiv='accopeninglink';
    }else if(activeTab == 'label'){
        scrollToDiv='acctLabelLink';
    }else if(activeTab == 'sanletter'){
        scrollToDiv='sanctiondetailsLink';
    }
    $('#'+scrollToDiv).click();

        ...
        <div class="kt">
            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-0 ms-3 mb-3 mt-1">
                <div class="d-flex align-items-center mt-2 mb-2">
                    ...
                    <div data-kt-countup="true" data-kt-countup-value="15000" data-kt-countup-prefix="$" data-kt-initialized="1" class="fs-8  fw-bold counted ms-2">Consolidated Report</div>
                </div>
            </div>
        </div>
                                        ...
                                        <form name="wicalist" id="wicalist" method="post" action="#">
                                            ...
                                            <table class="table align-middle table-row-dashed fs-8 gy-3" id="branch-maker-queue-details-table">
                                                ...
                                                <%
                                                    ...
                                                    List<Map<String,String>> conrpt = (List<Map<String,String>>) request.getAttribute("consolreport");
                                                    int count = 1;
                                                    for (Map<String,String> item : conrpt) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="col">
                                                            <div class="d-flex align-items-center me-2">
                                                                <div>
                                                                    <div class="fs-7 fw-bold me-2"><%= item.get("reccnt") %>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>

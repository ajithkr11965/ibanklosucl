        ...
        <div class="kt">
            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-0 ms-3 mb-3 mt-1">
                <div class="d-flex align-items-center mt-2 mb-2">
                    ...
                    <div data-kt-countup="true" data-kt-countup-value="15000" data-kt-countup-prefix="$" data-kt-initialized="1" class="fs-8  fw-bold counted ms-2">BOG Asset Queue</div>
                </div>
            </div>
        </div>
...
<div class="page-content pt-0">
    <%request.setAttribute("TAB","ACOPN");%>
                            ...
                            <div class="card card-xl-stretch mb-5 mb-xl-8">
                                ...
                                <div class="card-body py-3">
                                    <div class="table-responsive">
                                        <form name="bogfrm" id="bogfrm" method="post" action="wibogassets">
                                            ...
                                            <table class="table align-middle table-row-dashed fs-8 gy-3" id="branch-maker-queue-details-table">
                                                ...
                                                <tr class="text-start text-gray-400 fw-bold fs-8 text-uppercase gs-0">
                                                    ...
                                                    <th>Last Locked By</th>
                                                    <th>Last Locked On</th>
                                                    <%--                          <th>Status</th>--%>
                                                </tr>
                                                </thead>
                                                ...
                                                <%
                                                    ...
                                                    List<VehicleLoanMasterDTO> bogAssetQueue = (List<VehicleLoanMasterDTO>) request.getAttribute("bogAssetQueue");
                                                    int count = 1;
                                                    for (VehicleLoanMasterDTO item : bogAssetQueue) {
                                                        String lockDetails ="";
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <button type="button" name="modify-btn" value="CA"
                                                    ...
                                                    <td><%=item.getBrName()%></td>
                                                    <td><%=item.getRoName()%></td>
                                                    <td><%=item.getStatus()%></td>
                                                    <td><%=item.getQueueDate()%></td>
                                                    <td><%=item.getLastLockUser()==null?"":item.getLastLockUser()%></td>
                                                    <td><%=item.getLastLockDate()==null?"":item.getLastLockDate()%></td>
                                                </tr>
                                                <% } %>
                                                </tbody>
                                            </table>

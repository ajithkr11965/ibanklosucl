        ...
        <div class="kt">
            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-0 ms-3 mb-3 mt-1">
                <div class="d-flex align-items-center mt-2 mb-2">
                    ...
                    <div data-kt-countup="true" data-kt-countup-value="15000" data-kt-countup-prefix="$" data-kt-initialized="1" class="fs-8  fw-bold counted ms-2">CRT Queue</div>
                </div>
            </div>
        </div>
                                ...
                                <div class="card-body py-3">
                                    <div class="table-responsive">
                                        <form name="wibmlist" id="wibmlist" method="post" action="wichecker">
                                            ...
                                            <input type="hidden" name="action" value="CS" id="action_mod">
                                            <table class="table align-middle table-row-dashed fs-8 gy-3" id="branch-maker-queue-details-table">
                                                ...
                                                <%
                                                    ...
                                                    List<VehicleLoanMasterDTO> entryQueue = (List<VehicleLoanMasterDTO>) request.getAttribute("crtQueue");
                                                    int count = 1;
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <button type="button" name="modify-btn" value="CS"

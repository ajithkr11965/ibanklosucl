...
<%
  ...
  String insAmt = details.getInsAmt() != null ? details.getInsAmt().toString() : "-";
	...
	String loanAmountRecommended = "0";
	if(details.getLoanAmountRecommendedCPC()!=null) {
		loanAmountRecommended = details.getLoanAmountRecommendedCPC().toString();
	}

	String loanRoiRecommended = "0";
	if(details.getRoiRecommendedCPC()!=null) {
		loanRoiRecommended = details.getRoiRecommendedCPC().toString();
	}
			...
			<div class="row">
				...
				<div class="col-lg-12">
					<div class="mb-3 mt-3">
						<div class="row">
							<div class="col-md-4">
								<div class="fw-semibold">Card Rate (RBCPC Maker Recommended)</div>
								<div class="col-lg-12 form-control-feedback form-control-feedback-start">
									<input type="text" id="card-rate-cpc" class="form-control" value="<%= loanRoiRecommended %>" readonly>
								</div>
							</div>
							<div class="col-md-4">
								<div class="fw-semibold"> Loan Amount(RBCPC Maker Recommended)</div>
								<div class="col-lg-12 form-control-feedback form-control-feedback-start">
									<input type="text"  class="form-control" value="<%= loanAmountRecommended %>" readonly>
								</div>
							</div>
						</div>
					</div>

...
<%
    ...
    List<Map<String,Object>> bureauDetails = (List<Map<String,Object>>)request.getAttribute("bureauDetails");
 //   System.out.println("-sdsdsd-------------------------"+bureauDetails.size());
    ...
    String consentimg="",consentimgext="",sibcustomer="", appid ="";
    String originalSeenCertificate="",originalSeenCertificateExt="",cifmode="",custSig="",custSigExt="";

    String panseeding="",panStatus="",panNameStatus="",panDobStatus="";
    boolean panvalidated=false,uidvalidated=false;
    String res_stat="R";
    if(applicant!=null)
    {
         appid = applicant.getApplicantId().toString();
        // out.print("====>"+appid);
        fileclass="file-input";
        ...
        if(applicant.getKycapplicants()!=null){
            ...
            panseeding= kyc.getPanUidLink() != null ? kyc.getPanUidLink() : "";
            panStatus= kyc.getPanStatus() != null ? kyc.getPanStatus() : "";
            panNameStatus= kyc.getPanNameStatus() != null ? kyc.getPanNameStatus() : "";
            panDobStatus= kyc.getPanDobStatus() != null ? kyc.getPanDobStatus() : "";
        ...
        <div class="col-lg-6">
            ...
            <div class="mb-2">
              ...
              <div class="form-control-feedback form-control-feedback-start">
                <input type="text" class="form-control pan is-valid " placeholder="" minlength="10" maxlength="10" name="pan" value="<%=panNo%>">
            ...
            <div class="mb-2">
              ...
              <div class="form-control-feedback form-control-feedback-start">
                <input type="date" class="form-control pandob is-valid " placeholder="DD-MM-YYYY" name="pandob" value="<%=panDob%>">
                <div class="form-control-feedback-icon">
            ...
            <div class="mb-2">
              ...
              <div class="form-control-feedback form-control-feedback-start">
                <input type="text" class="form-control panname is-valid " placeholder=""  name="panname" value="<%=panName%>">
                <div class="form-control-feedback-icon">
        ...
        <div class="table-responsive border rounded">
            <table class="table">
                ...
                <tr>
                    ...
                    <th>Name Match</th>
                    <th>Dob Match</th>
                    <th>Bureau first name</th>
                    <th>Bureau middle name</th>
                    <th>Bureau last name</th>
                ...
                <tr>
                    <%
                        List<Misrct> panStatusList = (List<Misrct>) request.getAttribute("panStatusList");
                        List<Misrct> seedingStatusList = (List<Misrct>) request.getAttribute("seedingStatusList");

                    %>
                    <td><%=decodePanStatus(panStatus,panStatusList)%></td>
                    <td><%=decode(panNameStatus)%></td>
                    <td><%=decode(panDobStatus)%></td>
                     <td>
    <%
    if(bureauDetails != null && !bureauDetails.isEmpty() && appid.equals(bureauDetails.get(0).get("APPLICANT_ID").toString())) {

        out.print(bureauDetails.get(0).get("FIRST_NAME") != null ? bureauDetails.get(0).get("FIRST_NAME") : "NA");
    } else {
        out.print("NA");
    }
    %>
...
<td>
    <%
    if(bureauDetails != null && !bureauDetails.isEmpty() && appid.equals(bureauDetails.get(0).get("APPLICANT_ID").toString())) {
        out.print(bureauDetails.get(0).get("MIDDLE_NAME") != null ? bureauDetails.get(0).get("MIDDLE_NAME") : "NA");
    } else {
        out.print("NA");
    }
    %>
...
<td>
    <%
    if(bureauDetails != null && !bureauDetails.isEmpty() && appid.equals(bureauDetails.get(0).get("APPLICANT_ID").toString())) {
        out.print(bureauDetails.get(0).get("LAST_NAME") != null ? bureauDetails.get(0).get("LAST_NAME") : "NA");
    } else {
        out.print("NA");
    }
    %>
                    ...
                    <td><%=decodePanStatus(panseeding,seedingStatusList)%></td>
                </tr>
                </tbody>
            </table>
        </div>
    ...
    <%!
       ...
       private String decodePanStatus(String str,List<Misrct> misrctList){
           if(str==null || str.isBlank())
               return "";
           else if(misrctList.stream().anyMatch(t->t.getCodevalue().equalsIgnoreCase(str)))
              return misrctList.stream().filter(t->t.getCodevalue().equalsIgnoreCase(str)).findFirst().get().getCodedesc();
           else
              return  "";
       }
...
<%--                  </label>--%>
            ...
            <div class="mb-2">
              ...
              <div class="form-control-feedback form-control-feedback-start">
                <input type="text" class="form-control is-valid  uid" placeholder="" minlength="12" maxlength="12" name="uid"  value="<%=aadharRefNum%>">
                <div class="form-control-feedback-icon">
                  <i class="ph-identification-card text-muted"></i>
                </div>
              </div>
...
<%--            </div>--%>
            <div class="mb-2 uidmanual <%=uidmanual%>">
              ...
              <div class="form-control-feedback form-control-feedback-start">
                <input type="text" class="form-control is-valid  uidname" placeholder=""  name="uidname"  value="<%=aadharName%>">
                <div class="form-control-feedback-icon">
                  <i class="ph-user-circle text-muted"></i>
                </div>
              </div>

                ...
                <div class="table-responsive border-white border-opacity-15 mb-3 emptable-oth-div">
                    ...
                    <table class="table table-bordered emptable-oth"  >
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="empothcode" id="empothcode" class="form-control empworkexp-oth"  placeholder="Enter Experience" value="<%=vlEmployment.getOccupationCode()%>"></td>s
                            <td>

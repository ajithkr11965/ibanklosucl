...
<div class="d-flex flex-stack border rounded px-7 py-3 mb-2">
	<form class=" form-details  blacklistdetails" data-code="A-3" data-completed="" action="#">
		...
		<div class="w-100">
			<div class="accordion-header d-flex collapsed " data-bs-toggle="collapse" id="blacklistDetails" data-bs-target="#blacklisttable">
				<label class="btn btn-outline btn-outline-dashed btn-active-light-primary acdlen justify-content-start  p-5 d-flex align-items-center mb-2 <%=accordion_style%> <%=showFlg%>" for="blacklisttable">

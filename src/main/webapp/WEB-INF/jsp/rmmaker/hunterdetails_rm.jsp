...
%>
			...
			<div class="d-flex flex-stack border rounded px-7 py-3 mb-2">
				<div class="">
					<div class="accordion-header d-flex collapsed " data-bs-toggle="collapse" id="hunterlistDetails" data-bs-target="#huntertable">
						<label class="btn btn-outline btn-outline-dashed btn-active-light-primary acdlen justify-content-start  p-5 d-flex align-items-center mb-2 <%=accordion_style%> <%=showFlg%>" for="huntertable">
...
//																	}
         ...
         <%= vlHunterDetails != null ? "Re-run Hunter" : "Run Hunter" %>
    </span>
        ...
        Please wait... <span class="spinner-border spinner-border-sm align-middle ms-2"></span>
														...
														<td class="decision"><%= vlHunterDetails != null && vlHunterDetails.getApplicantId().equals(applicant.getApplicantId()) ? vlHunterDetails.getDecision() : "" %>
														</td>
														<td class="status"><%= vlHunterDetails != null && vlHunterDetails.getApplicantId().equals(applicant.getApplicantId()) ? (vlHunterDetails.getMatches() >0 ? "Match found" : "PASS") : "" %>
														</td>
                                                ...
                                                : ""
                                            %></td>
														<td class="status"><%= vlHunterDetails != null && vlHunterDetails.getApplicantId().equals(applicant.getApplicantId()) ? (vlHunterDetails.getHunterUserRemarks()!=null ? vlHunterDetails.getHunterUserRemarks() : "-") : "" %>
														</td>
													</tr>
													<%
															}

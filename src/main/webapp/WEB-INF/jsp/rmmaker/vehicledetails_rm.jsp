              ...
              <div class="row">
                <div class="row col-md-12">
                  ...
                  <div class="col-lg-12 form-control-feedback form-control-feedback-start">
                    <select data-placeholder="Please Select Dealer Account" id="dealerAccount" class="form-control select" disabled>
...
<%--                  <td></td>--%>
                  <td>
                    <input type="hidden"  name="other" id="other" class="form-control text-only" >
                    <input type="text"  name="onroad_price" id="onroad_price" class="form-control text-only" ></td>
                </tr>
                </tbody>
              </table>
            </div>
      ...
      <div class="text-end">
        ...
        <button type="button"  id="vehDetailsEdit" class="btn btn-warning my-1 me-2 comon"><i class="ph-note-pencil ms-2"></i>Edit</button>

...
%>
				<div class="flex-stack border rounded px-7 py-3 mb-2">
					<div class="">
                        ...
                        %>
                            <table id="dkScoreTable" class="table table-sm align-middle table-row-dashed table-row-gray-400 fs-8 gy-3">
                                ...
                                <tbody>
                                    ...
                                    %> <tr><td colspan="6">Run Race Score again</td></tr>
	                                <%
                                    }
	                                    }
                                    %>
                        ...
                        <button id="kt_button_runDKScore" type="button" class="btn btn-sm btn-primary">
                            <span class="indicator-label">
                                <%= dkScoreData == null || dkScoreData.isEmpty() ? "Fetch RACE Score" : "Refresh RACE Score" %>
                            </span>

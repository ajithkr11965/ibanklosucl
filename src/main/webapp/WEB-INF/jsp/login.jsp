			...
			<div class="d-flex flex-column flex-center py-7 py-lg-15 px-5 px-md-15 w-100">
				<div class="">
					<div class="parent" style="position: relative;top: -60px;left: 0;">
						<img class="image1" alt="excel_logo" style="width: 760px; position: relative;top: 0;left: 0;" src="assets/media/misc/lgmdata.png">
...
<%--	<img class="image1" alt="excel_logo" style="height: 63px;/*! width: 760px; */position: relative;top: -80px;left: 181px;z-index: 20;" src="https://infobank.sib.co.in:8443/iBank/Mis/images/hat.webp">--%>
<%--	<img class="image1" alt="excel_logo" style="height: 652px;/*! width: 760px; */position: relative;top: 0;left: 0;" src="assets/media/misc/lgmainpd.png">--%>
<%--	<img class="image2" id="logo" alt="excel_logo" style="height: 280px;width: 230px;position: absolute;top: 289px;left: 206px;" src="assets/media/misc/powerdrive.gif">--%>
					</div>
						...
						<div class="py-15">
							...
							<div class="card-body">
								...
								<div class="text-start mb-10">
									...
									<h2 data-kt-translate="sign-in-title" class="text-dark mb-3 fs-2x">SIB PowerDrive - Used Cars</h2>
									<!--end::Title-->
									<!--begin::Text-->
									<div class="text-gray-400 fw-semibold fs-6"
										 data-kt-translate="general-desc">Get the best financing for your pre-owned vehicle</div>
									<!--end::Link-->
								</div>
								<!--begin::Heading-->
								...
								<div class="fv-row mb-8 fv-plugins-icon-container">
                                    ...
                                    <i class="ki-duotone ki-user  text-danger fs-1" style="color: #006d77 !important;"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i>
                                                    </span>
								...
								<div class="fv-row mb-7 fv-plugins-icon-container">
									...
									<div
										...
										<i class="ki-duotone ki-shield-tick   text-danger fs-1" style="color: #006d77 !important;"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i>
                                                    </span>
										<input type="password" placeholder="Password" name="password" id="password" autocomplete="off" class="form-control" value="" style="background-color: #f9f9f9;border: white;">
										<div class="fv-plugins-message-container invalid-feedback"></div>
									</div>
								...
								<div class="d-flex justify-content-center">
									...
									<!--begin::Submit-->
									<button id="kt_sign_up_submit" class="btn btn-primary me-2 flex-shrink-0" style="background: linear-gradient(150deg, rgb(0, 109, 119) 15%, #005661 70%, #00444b 94%);width: 50%;">

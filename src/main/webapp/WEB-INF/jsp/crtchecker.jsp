        ...
        <div class="navbar-collapse collapse order-2 order-lg-1" >
								<span class="navbar-text d-none d-lg-inline-flex align-items-lg=center me-3">
                                  ...
                                  <input type="hidden" name="lockflg" id="lockflg" value="<%=request.getAttribute("lockflg")%>">
                                    ...
                                    <input type="hidden" name="bureauBlock" id="bureauBlock" value="<%=request.getAttribute("bureauBlock")%>">
...
<div class="page-content pt-0">
    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            ...
            <!-- Main charts -->
            <div class="d-flex flex-row min-vh-100 " id="loancheckerbody">
                <div id="appList" class="w-100">
                    ...
                    <div class="card">
                        ...
                        <ul class="nav nav-tabs nav-tabs-underline nav-justified mb-0" role="tablist" id="loanapp">
                            ...
                            %>
                            <li class="nav-item" role="presentation"><a href="#tab-A" class="nav-link apptype active  alert alert-primary  text-dark " data-bs-toggle="tab" aria-selected="false" role="tab" tabindex="-1" data-app="A"><i class="ph-user text-dark fw-semibold"></i>APPLICANT</a></li>
                            <%
                            } else if ("C".equals(applicant.getApplicantType())) {
                            %>
                            <li class="nav-item" role="presentation"><a href="#tab-C-<%=coApplicantCount%>" class="nav-link apptype   alert alert-primary  text-dark " data-bs-toggle="tab" aria-selected="false" role="tab" tabindex="-1" data-app="C-<%=coApplicantCount%>"><i class="ph-user-circle-plus text-black"></i><span data-applicationtype="C">Co-Applicant-<%=coApplicantCount%></span>
                                </a>
                            </li>
                            <%
                                coApplicantCount++;
                            ...
                            %>
                            <li class="nav-item" role="presentation"><a href="#tab-G-1" class="nav-link apptype   alert alert-primary  text-dark " data-bs-toggle="tab" aria-selected="false" role="tab" tabindex="-1" data-app="G-1"><i class="ph-bank text-dark fw-semibold"></i><span data-applicationtype="G">GUARANTOR</span>
                            ...
                            %>
                            <li class="nav-item" role="presentation"><a href="#tab-CA" class="nav-link apptype active  alert alert-primary  text-dark " data-bs-toggle="tab" aria-selected="false" role="tab" tabindex="-1" data-app="A"><i class="ph-user text-dark fw-semibold"></i>APPLICANT</a></li>
                            <%
                                }
                        ...
                        <div class="tab-content card-body" id="loanbody">
                            ...
                            <div class="tab-pane fade active show" id="tab-A" role="tabpanel">
                                ...
                                %>
                                <jsp:include page="crtchecker/generaldetails_crt.jsp">
                                    <jsp:param name="apponly" value="Y"/>
                                </jsp:include>
                                <jsp:include page="crtchecker/kycdetails_crt.jsp" />
                                <jsp:include page="crtchecker/basicdetails_crt.jsp" />
                                <jsp:include page="crtchecker/employmentdetails_crt.jsp" />
                                <jsp:include page="crtchecker/Incomedetails.jsp" />
                                <jsp:include page="crtchecker/creditcheck_crt.jsp" />
                            </div>
                            <%
                            }
                            else if ("C".equals(applicant.getApplicantType())) {
                        ...
                        <div class="card-group-vertical">
                            <div class="card border shadow-none">
                                <div class="card-header">
                                    <h6 class="mb-0">
                                        <a data-bs-toggle="collapse" class="d-flex align-items-center text-body" href="#vehDetailsContent" aria-expanded="false" id="vehDetailslink" style="color: #958207 !important;">
                                ...
                                <div id="vehDetailsContent"  class="collapse" style="">
                                    <div class="card-body">
                                        <jsp:include page="crtchecker/vehicledetails.jsp" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card border shadow-none">
                                <div class="card-header">
                                    <h6 class="mb-0">
                                        <a class="d-flex align-items-center text-body" data-bs-toggle="collapse" href="#loanDetailsContent" aria-expanded="false" id="loanDetailslink" style="color: #4c83d9  !important;">
                                ...
                                <div id="loanDetailsContent"class="collapse" style="">
                                    <div class="card-body">
                                        <jsp:include page="crtchecker/loandetails.jsp" />
                                    </div>
                                </div>
                            </div>
			    <div class="card border shadow-none">
                                <div class="card-header">
                                    <h6 class="mb-0">
                                        <a class="d-flex align-items-center text-body" data-bs-toggle="collapse" href="#eligibilityDetailsContent" aria-expanded="false" id="ebityDetailslink" style="color: #46720d !important;">
                                ...
                                <div id="eligibilityDetailsContent"  class="collapse" style="">
                                    <div class="card-body">
                                        <jsp:include page="crtchecker/eligibilitydetails.jsp" />
                                    </div>
                                </div>
                            </div>

                    <div class="card card-body">
                        <jsp:include page="crtchecker/racescore_crt.jsp"/>
<%--                        <jsp:include page="checker/blacklistdetails_allot.jsp"/>--%>

                    </div>

                    <div class="card card-body">
                        <jsp:include page="crtchecker/hunterdetails_crt.jsp"/>
                    </div>
                    <div class="card card-body">
                        <jsp:include page="crtchecker/blacklistdetails_crt.jsp"/>
                    </div>
                    <div class="card card-body">
                        <jsp:include page="crtchecker/fcv_cpv_cfr_details.jsp"/>
                    </div>

                    <div class="card card-body">
                        <jsp:include page="crtchecker/bredetails_crt.jsp"/>
                    </div>
                    ...
                    <div class="card card-body">
                        <jsp:include page="crtchecker/vehicleloanwarning.jsp"/>
                            ...
                            <div class="card card-body">
                                <jsp:include page="crtchecker/materialtc_rm.jsp"/>
                            </div>


                    <div class="card card-body kt">
                        <div class="row col-md-12">
                            ...
                            <div class="col-lg-12 form-control-feedback form-control-feedback-start">
                                <textarea  data-placeholder="Enter Remarks" id="crtremarks" maxlength="4000" class="form-control textarea"></textarea>
                            </div>
                        </div>
                    </div>


                    <div class="text-center kt mt-3">

                        <button type="button" id="CrtApprove" class="btn btn-sm btn-success CrtApprove ms-1 me-1 crtsubmit">Approve<i class="ph-paper-plane-tilt ms-2"></i></button>
                        <button type="button" id="CrtSendBack" class="btn btn-sm btn-warning CrtSendBack ms-1 me-1 crtsubmit">Send Back<i class="ph-paper-plane-tilt ms-2"></i></button>
                        <button type="button" id="CrtReject" class="btn btn-sm btn-danger CrtReject ms-1 me-1 crtsubmit">Reject <i class="ph-paper-plane-tilt ms-2"></i></button>
...
<script src="assets/js/custom/checker/crtcheckermaster.js"></script>
